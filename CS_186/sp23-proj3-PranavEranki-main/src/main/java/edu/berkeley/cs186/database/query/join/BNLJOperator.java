...
public class BNLJOperator extends JoinOperator {
    ...
    private class BNLJIterator implements Iterator<Record>{
        ...
        private void fetchNextLeftBlock() {
            ...
            //get an iterator to the next num_buffers - 2 pages of leftSourceIterator
        ...
        private Record fetchNextRecord() {
            ...
            while (true) {
                ...
                if (rightPageIterator.hasNext()) {
                    ...
                    // Case 2: The right page uterator doesnt have a value to yield
                    ...
                    // Case 3: Neither of the iteartors have values to yield, but
                    // there's more right pages
                    ...
                    // Case 4: Neither right page iterator nor the left page iter
                    // have values to yield but there are still left blocks.
