...
public class IntListTest {
    ...
    public void testSquareListRecursive() {
        IntList inputList = IntList.list(1, 2, 3);
        IntList outputList = IntList.squareListRecursive(inputList);
        assertEquals(IntList.list(1, 4, 9), outputList);
        assertEquals(IntList.list(1, 2, 3), inputList);
    }
