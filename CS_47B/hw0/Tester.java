...
public class Tester {
    ...
    public static void maxTest() {
        ...
        assertIntEquals(9, Solutions.max(new int[] {1,7,3,9,4}), "maxTest");
        assertIntEquals(10, Solutions.max(new int[] {-1, 10, -5, 4, 3, 1}), "maxTest");
    ...
    public static void threeSumTest() {
        // Change call to threeSum to make this call yours.
        assertTrue(Solutions.threeSum(new int[] { 1, 2, -3 }), "3SUM Test 1"); // 1 + 2 - 3 = 0
        assertTrue(Solutions.threeSum(new int[] { -6, 3, 10, 200 }), "3SUM Test 2"); // 3 + 3 - 6 = 0
        assertFalse(Solutions.threeSum(new int[] {1, -900, 7}), "3SUM Test 3");
        // REPLACE THIS WITH MORE TESTS.
    }
