...
public class Main {
    ...
    public static void writeStory(String[] args) {
        ...
        File storyy = Utils.join(CAPERS_FOLDER, "story");
        if (storyy.exists()) {
            Utils.writeContents(storyy,Utils.readContentsAsString(storyy) + "\n" + args[1]);
        } else {
            Utils.writeContents(storyy, args[1]);
        }
        System.out.println(Utils.readContentsAsString(storyy));
    }
